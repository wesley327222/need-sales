...
export default async function DashboardPage() {
  ...
  const [{ data: rawMeetings }, { data: rawSellers }, { data: rawClientes }, { data: rawLigacoes }] = await Promise.all([
    service
      .from('reunioes')
      .select('id, titulo, nota_geral, nota_escuta, nota_objecoes, nota_apresentacao, data_hora, status, vendedor_id, cliente_id')
  ...
  return <DashboardClient meetings={meetings} ligacoes={ligacoes} sellers={sellers} />
}
